...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        errors.firstname= "First name should be less than 13 characters";
        ...
        errors.lastname= "Last name should be less than 13 characters";

        const reg = /^\d+$/;
        if (this.state.touched.telnum && !reg.test(telnum))
        errors.telnum = "Tel. Number should only contail only numbers";
                ...
                <div className="col-12 col-md-9">
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Label htmlFor="feedback" md={2}>Your Feedback</Label>
                            <Col md={10}>
                                <Input type="textarea" rows="12" id="message" name="message"
